...
class ListBankAccountItem {
  ...
  factory ListBankAccountItem.fromJson(Map<String, dynamic> json) =>
      _$ListBankAccountItemFromJson(json);
}
...
class ListBankAccounts {
  ...
  factory ListBankAccounts.fromJson(Map<String, dynamic> json) =>
      _$ListBankAccountsFromJson(json);
}
...
Future<ListBankAccounts> listBankAccounts() async {
  ...
  if (response.statusCode == 200) {
    return ListBankAccounts.fromJson(
